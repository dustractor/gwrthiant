// Clwyd converts its parameter or recieved signal to a 16-bit binary
// representation and outputs the bits as gates of a 16-channel
// polyphonic signal with the option to shift/rotate the gates.
//
